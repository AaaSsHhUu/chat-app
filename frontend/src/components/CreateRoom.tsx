  ...
  return (
    <div className="z-50 fixed top-1/5 rounded-sm left-1/3 max-w-[40vw] w-full bg-gray-100 dark:bg-gray-900 flex items-center justify-center p-4 font-sans antialiased">
      ...
      <div className="flex justify-center mb-6 border-b border-gray-200 dark:border-gray-700">
        <button
        className={`flex-1 py-3 px-4 text-center text-lg font-medium rounded-t-lg transition-all duration-300 focus:outline-none ${
          activeTab === 'oneToOne'
      ...
      {activeTab === 'oneToOne' && (
        ...
        <div>
          ...
          <input
            ...
            className={`w-full px-4 py-2 border rounded-lg focus:ring-indigo-500 focus:border-indigo-500 shadow-sm transition-all duration-200 ${
            oneToOneError ? 'border-red-500' : 'border-gray-300 dark:border-gray-600'
      ...
      {activeTab === 'group' && (
        ...
        <div>
          ...
          <input
            ...
            className={`flex-1 px-4 py-2 border rounded-lg focus:ring-indigo-500 focus:border-indigo-500 shadow-sm transition-all duration-200 ${
            groupInputError ? 'border-red-500' : 'border-gray-300 dark:border-gray-600'
            } bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100`}
